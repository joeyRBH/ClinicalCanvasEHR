...
2. **Find Your Project**: Look for `sessionably-ehr` or `sessionably`
...
3. Select: `github.com/joeyRBH/sessionably`
...
3. Click "Configure"
4. Ensure `sessionably` repository has access
5. Save changes
...
✅ Your app URL: `https://sessionably-[hash].vercel.app`  
...
2. **Check GitHub Webhooks**:
   - Go to: `https://github.com/joeyRBH/sessionably/settings/hooks`
   - Find Vercel webhook
